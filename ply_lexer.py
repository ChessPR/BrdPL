...
def p_timer_expression(p):
    '''
    timer_expression : TIMER LPAREN expression COMMA expression COMMA expression RPAREN
    '''
...
def p_dice_expression(p):
    '''
    dice_expression : DICE LPAREN expression COMMA expression RPAREN
    '''
    p[0] = ('dice', p[1], p[2])

def p_player_expression(p):
    '''
    player_expression : PLAYER LPAREN expression COMMA expression RPAREN
    '''
